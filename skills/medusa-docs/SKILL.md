---
name: medusa-docs
description: Expert guidance for building Medusa e-commerce applications with best practices for architecture, API patterns, data modeling. Ensures adherence to Medusa 2.0+ conventions and optimal performance patterns.
---

# Medusa Architect Skill

## Purpose

Answer coding questions and provide accurate and up to date info on Medusa.js based on a codebase provided.

---

Currently you have access to the following codebases:

- Medusa.js - `.medusa-repo`
